...
var tokenToCheck = process.env.ACCESSTOKEN1, salt = process.env.SALT;
exports.default = {
    Query: {
    ...
    Mutation: {
        ...
        createOrder: function (parent, _a, _b) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                var extractUsernameForuserId, getUserId, result, deleteFromCart;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            extractUsernameForuserId = jsonwebtoken_1.decode(tokenToCheck, { complete: true });
                            if (!(extractUsernameForuserId != null)) return [3 /*break*/, 4];
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, prisma.order.create({
                                    data: __assign(__assign({}, data), { user: {
                        ...
                        case 3:
                            deleteFromCart = _c.sent();
                            return [2 /*return*/, result];
                        case 4: throw new Error('no token provided');
                    }
                });
            });
        },
